...
Optimized with compact 2-line stacked badges to guarantee ZERO overlap on any card border.
"""
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@500;600;700;800;900&family=JetBrains+Mono:wght@600;700;800&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
  <style>
    * {
...
<body>
  ...
  <div class="diagram-stage">
    ...
    <svg class="svg-layer" viewBox="0 0 1856 875" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- Card 1 right edge: (268, 455) -> Card 2 left edge: (366, 455) -->
      ...
      <!-- Card 2 upper-right: (621, 310) -> Card 3 left: (775, 230) -->
      ...
      <!-- Card 2 lower-right: (621, 600) -> Card 4 left: (775, 620) -->
      ...
      <!-- Card 5 right: (1485, 455) -> Card 6 left: (1572, 455) -->
      ...
      <!-- 6. Security -> Backend & Core Architecture (Persistence Return Loop - Lower Corridor) -->
      <!-- Card 6 bottom center: (1702, 690) -> loop under all cards at Y:840 -> Card 2 bottom center: (493, 690) -->
      ...
      <!-- Card 6 top-left: (1572, 280) -> Card 5 top-right: (1485, 280) -->
      ...
      <!-- 8. Market Linkage -> Frontend & UI (Live Listing Feed - Upper Corridor) -->
      <!-- Card 5 top center: (1345, 220) -> loop across top corridor at Y:14 -> Card 1 top center: (143, 220) -->
